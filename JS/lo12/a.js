...
while (true) {
    var a = roll();
    if (a == r[1] || a == r[2] || a == r[3] || a == r[4] || a == r[5] || a == r[6]) {
        a = roll();
    }
    else {
        bonus = a;
...
document.write(r + "<br> bonus 번호는 " + bonus + "<br>");
...
switch (numbCorr) {
    case 0:
        document.write(numbCorr + "개 맞췄습니다. 꽝입니다.");
        break;
    case 1:
        document.write(numbCorr + "개 맞췄습니다. 꽝입니다.");
        break;
    case 2:
        ...
        break;
    case 3:
        document.write(numbCorr + "개 맞췄습니다. 5등입니다.");
        break;
    case 4:
        document.write(numbCorr + "개 맞췄습니다. 4등입니다.");
        break;
    case 5:
        check(bonus);
        if (numbCorr == 6) {
            document.write("숫자 5개와 보너스 숫자를 맞췄습니다. 2등입니다.");
            break;
        }
        else {
            document.write(numbCorr + "개 맞췄습니다. 3등입니다.");
            break;
        }
    case 6:
        document.write(numbCorr + "개 맞췄습니다. 1등입니다.");
        break;
}